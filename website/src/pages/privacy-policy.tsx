  ...
  return (
    <div className="p-16">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Shortzo.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Shortzo, accessible from
            <a href="https://www.shortzoo.com" rel="external nofollow noopener">
              https://www.shortzoo.com
            </a>
          </p>
        </li>
        <li>
      ...
      <p>
        ...
        close Your web browser. Learn more about cookies on the article.
      </p>
      <p>
      ...
      <ul>
        <li>By email: contact@shortzoo.com</li>
      </ul>
    </div>
  );
}
