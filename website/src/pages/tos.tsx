export default function TermsOfService() {
  return (
    <div className="p-16">
      ...
      <p>
        The Shortzoo website located at https://www.shortzoo.com is a
        copyrighted work belonging to Shortzoo. Certain features of the Site may
      ...
      <p>
        ...
        Shortzoo uses ‘cookies’. These cookies are used to store information
      ...
      <p>
        ...
        the Company should be sent to: 38 College Street, Hanover, NH, 03755.
      ...
      <p>Address: 38 College Street, Hanover, NH, 03755</p>
      <p>Email: egemensahin91@gmail.com</p>
    </div>
  );
}
