...
export default function ContentLarge({
  ...
  return (
    <section className="mx-auto w-full max-w-7xl items-center px-5 py-12 text-center align-middle md:px-12 lg:px-16 lg:py-24">
      ...
      <p className="mx-auto mt-4 max-w-xl text-base leading-relaxed text-teal-500 lg:mt-8">
        {body}
      </p>
